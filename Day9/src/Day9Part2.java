...
public class Day9Part2 {
    public static void main(String[] args) {
        try(Scanner scanner = new Scanner(new File("input.txt"))) {
            ...
            while(scanner.hasNextLine()) {
                ...
                sum += getPreviousInSequence(curr);
            }
    ...
    /**
     * Recursively calculates the previous number in a sequence based on the input array.
     *
     * @param input The input array representing a sequence.
     * @return The previous number in the sequence.
     */
    private static int getPreviousInSequence(int[] input) {
        int count = 0;
        ...
        return input[0] - getPreviousInSequence(dif);
    }
}